...
public class GeoJsonParser {
    ...
    private static GeoJsonPoint createPoint(JSONArray coordinates) throws JSONException {
        com.example.navdrawer.lib.GeoJsonParser.LatLngAlt latLngAlt = parseCoordinate(coordinates);
    ...
    private static GeoJsonLineString createLineString(JSONArray coordinates) throws JSONException {
        ArrayList<com.example.navdrawer.lib.GeoJsonParser.LatLngAlt> latLngAlts = parseCoordinatesArray(coordinates);
        ArrayList<LatLng> latLngs = new ArrayList<>();
        ArrayList<Double> altitudes = new ArrayList<>();

        for (com.example.navdrawer.lib.GeoJsonParser.LatLngAlt latLngAlt : latLngAlts) {
     ...
     */
    private static com.example.navdrawer.lib.GeoJsonParser.LatLngAlt parseCoordinate(JSONArray coordinates) throws JSONException {
        ...
        return new com.example.navdrawer.lib.GeoJsonParser.LatLngAlt(latLng, altitude);
    }
     ...
     * @throws JSONException if coordinates cannot be parsed
     */
    private static ArrayList<com.example.navdrawer.lib.GeoJsonParser.LatLngAlt> parseCoordinatesArray(JSONArray coordinates)
            throws JSONException {
        ArrayList<com.example.navdrawer.lib.GeoJsonParser.LatLngAlt> coordinatesArray = new ArrayList<>();
        for (int i = 0; i < coordinates.length(); i++) {
    ...
    private static ArrayList<ArrayList<LatLng>> parseCoordinatesArrays(JSONArray coordinates)
        ...
        for (int i = 0; i < coordinates.length(); i++) {
            ArrayList<com.example.navdrawer.lib.GeoJsonParser.LatLngAlt> latLngAlts = parseCoordinatesArray(coordinates.getJSONArray(i));
