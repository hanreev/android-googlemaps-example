package com.example.gmaps.ui.home;
...
import com.example.gmaps.lib.ExpandableListView;
import com.example.gmaps.lib.FeatureInfoAdapter;
import com.example.gmaps.lib.GeoJsonParser;
import com.example.gmaps.lib.KmpMultipartRequest;
import com.example.gmaps.lib.Utils;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(mCenterPoint, 9));
...
//        fetchGeoJson("jembatan");
    ...
    private void fetchGeoJson(final String layerName) {
        String url = "https://sijj-palu.karogis.com/service.php?action=getGeojson&geojsonTable=" + layerName;
    ...
    private void submitForm() {
        ...
        KmpMultipartRequest request = new KmpMultipartRequest("https://sijj-palu.karogis.com/service.php?action=inputKerusakan", new Response.Listener<NetworkResponse>() {
            @Override
